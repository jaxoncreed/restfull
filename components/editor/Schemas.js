                    ...
                    {this.props.request.schemas[this.state.schemaIndex].attributes.map(function(attribute, attrIndex) {
                        return (
                            <div>
                                ...
                                <input type="checkbox" id="autoIncrement" ref="autoIncrement" checked={this.props.request.schemas[this.state.schemaIndex].attributes[attrIndex].autoIncrement} onChange={this.updateCheckBoxInfo.bind(null, ['schemas', this.state.schemaIndex, 'attributes', attrIndex, 'autoIncrement'])}>Is Required</input>
                            </div>
                        );
                    }.bind(this))}
